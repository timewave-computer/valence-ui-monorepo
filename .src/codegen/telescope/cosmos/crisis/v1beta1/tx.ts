...
export const MsgVerifyInvariant = {
  ...
  toAmino(message: MsgVerifyInvariant): MsgVerifyInvariantAmino {
    ...
    obj.invariant_module_name =
      message.invariantModuleName === ""
        ? undefined
        : message.invariantModuleName;
    obj.invariant_route =
      message.invariantRoute === "" ? undefined : message.invariantRoute;
    return obj;
  },
...
export const MsgVerifyInvariantResponse = {
  ...
  fromProtoMsg(
    message: MsgVerifyInvariantResponseProtoMsg,
  ): MsgVerifyInvariantResponse {
  ...
  toProtoMsg(
    message: MsgVerifyInvariantResponse,
  ): MsgVerifyInvariantResponseProtoMsg {
    return {
      typeUrl: "/cosmos.crisis.v1beta1.MsgVerifyInvariantResponse",
