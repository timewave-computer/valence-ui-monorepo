...
export const TableDescriptor = {
  ...
  fromAmino(object: TableDescriptorAmino): TableDescriptor {
    ...
    message.index =
      object.index?.map((e) => SecondaryIndexDescriptor.fromAmino(e)) || [];
  ...
  toAmino(message: TableDescriptor): TableDescriptorAmino {
    const obj: any = {};
    obj.primary_key = message.primaryKey
      ? PrimaryKeyDescriptor.toAmino(message.primaryKey)
      : undefined;
    if (message.index) {
      obj.index = message.index.map((e) =>
        e ? SecondaryIndexDescriptor.toAmino(e) : undefined,
      );
    } else {
...
export const PrimaryKeyDescriptor = {
  ...
  toAmino(message: PrimaryKeyDescriptor): PrimaryKeyDescriptorAmino {
    ...
    obj.auto_increment =
      message.autoIncrement === false ? undefined : message.autoIncrement;
    return obj;
  },
...
export const SecondaryIndexDescriptor = {
  ...
  fromAminoMsg(
    object: SecondaryIndexDescriptorAminoMsg,
  ): SecondaryIndexDescriptor {
    return SecondaryIndexDescriptor.fromAmino(object.value);
  },
  toAminoMsg(
    message: SecondaryIndexDescriptor,
  ): SecondaryIndexDescriptorAminoMsg {
    return {
      type: "cosmos-sdk/SecondaryIndexDescriptor",
  ...
  fromProtoMsg(
    message: SecondaryIndexDescriptorProtoMsg,
  ): SecondaryIndexDescriptor {
  ...
  toProtoMsg(
    message: SecondaryIndexDescriptor,
  ): SecondaryIndexDescriptorProtoMsg {
    return {
      typeUrl: "/cosmos.orm.v1.SecondaryIndexDescriptor",
