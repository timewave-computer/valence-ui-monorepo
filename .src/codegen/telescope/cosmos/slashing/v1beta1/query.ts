...
export const QuerySigningInfoRequest = {
  ...
  fromAminoMsg(
    object: QuerySigningInfoRequestAminoMsg,
  ): QuerySigningInfoRequest {
  ...
  fromProtoMsg(
    message: QuerySigningInfoRequestProtoMsg,
  ): QuerySigningInfoRequest {
  ...
  toProtoMsg(
    message: QuerySigningInfoRequest,
  ): QuerySigningInfoRequestProtoMsg {
    return {
      typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoRequest",
...
export const QuerySigningInfoResponse = {
  ...
  fromAmino(object: QuerySigningInfoResponseAmino): QuerySigningInfoResponse {
    ...
    if (
      ...
      message.valSigningInfo = ValidatorSigningInfo.fromAmino(
  ...
  fromAminoMsg(
    object: QuerySigningInfoResponseAminoMsg,
  ): QuerySigningInfoResponse {
    return QuerySigningInfoResponse.fromAmino(object.value);
  },
  toAminoMsg(
    message: QuerySigningInfoResponse,
  ): QuerySigningInfoResponseAminoMsg {
    return {
      type: "cosmos-sdk/QuerySigningInfoResponse",
  ...
  fromProtoMsg(
    message: QuerySigningInfoResponseProtoMsg,
  ): QuerySigningInfoResponse {
  ...
  toProtoMsg(
    message: QuerySigningInfoResponse,
  ): QuerySigningInfoResponseProtoMsg {
    return {
      typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfoResponse",
...
export const QuerySigningInfosRequest = {
  ...
  fromAminoMsg(
    object: QuerySigningInfosRequestAminoMsg,
  ): QuerySigningInfosRequest {
    return QuerySigningInfosRequest.fromAmino(object.value);
  },
  toAminoMsg(
    message: QuerySigningInfosRequest,
  ): QuerySigningInfosRequestAminoMsg {
    return {
      type: "cosmos-sdk/QuerySigningInfosRequest",
  ...
  fromProtoMsg(
    message: QuerySigningInfosRequestProtoMsg,
  ): QuerySigningInfosRequest {
  ...
  toProtoMsg(
    message: QuerySigningInfosRequest,
  ): QuerySigningInfosRequestProtoMsg {
    return {
      typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosRequest",
...
export const QuerySigningInfosResponse = {
  ...
  fromAmino(object: QuerySigningInfosResponseAmino): QuerySigningInfosResponse {
    const message = createBaseQuerySigningInfosResponse();
    message.info =
      object.info?.map((e) => ValidatorSigningInfo.fromAmino(e)) || [];
    if (object.pagination !== undefined && object.pagination !== null) {
  ...
  toAmino(message: QuerySigningInfosResponse): QuerySigningInfosResponseAmino {
    ...
    if (message.info) {
      obj.info = message.info.map((e) =>
        e ? ValidatorSigningInfo.toAmino(e) : undefined,
      );
    } else {
  ...
  fromAminoMsg(
    object: QuerySigningInfosResponseAminoMsg,
  ): QuerySigningInfosResponse {
    return QuerySigningInfosResponse.fromAmino(object.value);
  },
  toAminoMsg(
    message: QuerySigningInfosResponse,
  ): QuerySigningInfosResponseAminoMsg {
    return {
      type: "cosmos-sdk/QuerySigningInfosResponse",
  ...
  fromProtoMsg(
    message: QuerySigningInfosResponseProtoMsg,
  ): QuerySigningInfosResponse {
  ...
  toProtoMsg(
    message: QuerySigningInfosResponse,
  ): QuerySigningInfosResponseProtoMsg {
    return {
      typeUrl: "/cosmos.slashing.v1beta1.QuerySigningInfosResponse",
