...
export const ValidatorSigningInfo = {
  ...
  fromPartial(object: Partial<ValidatorSigningInfo>): ValidatorSigningInfo {
    ...
    message.indexOffset =
      object.indexOffset !== undefined && object.indexOffset !== null
        ? BigInt(object.indexOffset.toString())
        : BigInt(0);
    ...
    message.missedBlocksCounter =
      ...
      object.missedBlocksCounter !== null
        ? BigInt(object.missedBlocksCounter.toString())
        : BigInt(0);
    return message;
  },
  fromAmino(object: ValidatorSigningInfoAmino): ValidatorSigningInfo {
    ...
    if (object.jailed_until !== undefined && object.jailed_until !== null) {
      message.jailedUntil = fromTimestamp(
        Timestamp.fromAmino(object.jailed_until),
      );
    }
  ...
  toAmino(message: ValidatorSigningInfo): ValidatorSigningInfoAmino {
    ...
    obj.start_height =
      message.startHeight !== BigInt(0)
        ? message.startHeight.toString()
        : undefined;
    obj.index_offset =
      message.indexOffset !== BigInt(0)
        ? message.indexOffset.toString()
        : undefined;
    obj.jailed_until = message.jailedUntil
      ? Timestamp.toAmino(toTimestamp(message.jailedUntil))
      : new Date();
    obj.tombstoned =
      message.tombstoned === false ? undefined : message.tombstoned;
...
export const Params = {
  ...
  fromPartial(object: Partial<Params>): Params {
    ...
    message.signedBlocksWindow =
      ...
      object.signedBlocksWindow !== null
        ? BigInt(object.signedBlocksWindow.toString())
        : BigInt(0);
  ...
  fromAmino(object: ParamsAmino): Params {
    ...
    if (
      ...
      message.downtimeJailDuration = Duration.fromAmino(
  ...
  toAmino(message: Params): ParamsAmino {
    ...
    obj.signed_blocks_window =
      message.signedBlocksWindow !== BigInt(0)
        ? message.signedBlocksWindow.toString()
        : undefined;
    obj.min_signed_per_window = message.minSignedPerWindow
      ? base64FromBytes(message.minSignedPerWindow)
      : "";
