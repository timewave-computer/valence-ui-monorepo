...
export type MsgSubmitEvidenceEncoded = Omit<MsgSubmitEvidence, "evidence"> & {
  /** evidence defines the evidence of misbehavior. */ evidence?:
    | AnyProtoMsg
    | undefined;
};
/**
...
export const MsgSubmitEvidence = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.evidence = Cosmos_evidencev1beta1Evidence_InterfaceDecoder(
            reader,
          ) as Any;
          break;
        default:
  ...
  fromAmino(object: MsgSubmitEvidenceAmino): MsgSubmitEvidence {
    ...
    if (object.evidence !== undefined && object.evidence !== null) {
      message.evidence = Cosmos_evidencev1beta1Evidence_FromAmino(
        object.evidence,
      );
    }
    return message;
  ...
  toAmino(message: MsgSubmitEvidence): MsgSubmitEvidenceAmino {
    ...
    obj.evidence = message.evidence
      ? Cosmos_evidencev1beta1Evidence_ToAmino(message.evidence as Any)
      : undefined;
    return obj;
  },
...
export const MsgSubmitEvidenceResponse = {
  ...
  fromAminoMsg(
    object: MsgSubmitEvidenceResponseAminoMsg,
  ): MsgSubmitEvidenceResponse {
    return MsgSubmitEvidenceResponse.fromAmino(object.value);
  },
  toAminoMsg(
    message: MsgSubmitEvidenceResponse,
  ): MsgSubmitEvidenceResponseAminoMsg {
    return {
      type: "cosmos-sdk/MsgSubmitEvidenceResponse",
  ...
  fromProtoMsg(
    message: MsgSubmitEvidenceResponseProtoMsg,
  ): MsgSubmitEvidenceResponse {
...
export const Cosmos_evidencev1beta1Evidence_InterfaceDecoder = (
  input: BinaryReader | Uint8Array,
): Any => {
  const reader =
    input instanceof BinaryReader ? input : new BinaryReader(input);
...
export const Cosmos_evidencev1beta1Evidence_FromAmino = (
  content: AnyAmino,
): Any => {
