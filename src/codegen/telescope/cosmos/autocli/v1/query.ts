...
export const AppOptionsResponse_ModuleOptionsEntry = {
  ...
  fromPartial(
    object: Partial<AppOptionsResponse_ModuleOptionsEntry>,
  ): AppOptionsResponse_ModuleOptionsEntry {
    const message = createBaseAppOptionsResponse_ModuleOptionsEntry();
  ...
  fromAmino(
    object: AppOptionsResponse_ModuleOptionsEntryAmino,
  ): AppOptionsResponse_ModuleOptionsEntry {
    const message = createBaseAppOptionsResponse_ModuleOptionsEntry();
  ...
  toAmino(
    message: AppOptionsResponse_ModuleOptionsEntry,
  ): AppOptionsResponse_ModuleOptionsEntryAmino {
    const obj: any = {};
    obj.key = message.key === "" ? undefined : message.key;
    obj.value = message.value
      ? ModuleOptions.toAmino(message.value)
      : undefined;
    return obj;
  },
  fromAminoMsg(
    object: AppOptionsResponse_ModuleOptionsEntryAminoMsg,
  ): AppOptionsResponse_ModuleOptionsEntry {
    return AppOptionsResponse_ModuleOptionsEntry.fromAmino(object.value);
  },
  fromProtoMsg(
    message: AppOptionsResponse_ModuleOptionsEntryProtoMsg,
  ): AppOptionsResponse_ModuleOptionsEntry {
