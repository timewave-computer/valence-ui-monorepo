...
export const ModuleOptions = {
  ...
  toAmino(message: ModuleOptions): ModuleOptionsAmino {
    const obj: any = {};
    obj.tx = message.tx
      ? ServiceCommandDescriptor.toAmino(message.tx)
      : undefined;
...
export const ServiceCommandDescriptor_SubCommandsEntry = {
  ...
  fromPartial(
    object: Partial<ServiceCommandDescriptor_SubCommandsEntry>,
  ): ServiceCommandDescriptor_SubCommandsEntry {
    const message = createBaseServiceCommandDescriptor_SubCommandsEntry();
  ...
  toAmino(
    ...
    obj.value = message.value
      ? ServiceCommandDescriptor.toAmino(message.value)
      : undefined;
    return obj;
  },
  fromAminoMsg(
  ...
  fromProtoMsg(
    message: ServiceCommandDescriptor_SubCommandsEntryProtoMsg,
  ): ServiceCommandDescriptor_SubCommandsEntry {
...
export const ServiceCommandDescriptor = {
  ...
  fromPartial(
    object: Partial<ServiceCommandDescriptor>,
  ): ServiceCommandDescriptor {
    const message = createBaseServiceCommandDescriptor();
  ...
  fromAmino(object: ServiceCommandDescriptorAmino): ServiceCommandDescriptor {
    ...
    message.rpcCommandOptions =
      object.rpc_command_options?.map((e) => RpcCommandOptions.fromAmino(e)) ||
      [];
    ...
    if (
      object.enhance_custom_command !== undefined &&
      object.enhance_custom_command !== null
    ) {
  ...
  toAmino(message: ServiceCommandDescriptor): ServiceCommandDescriptorAmino {
    ...
    obj.enhance_custom_command =
      message.enhanceCustomCommand === false
        ? undefined
        : message.enhanceCustomCommand;
    return obj;
  },
  fromAminoMsg(
    object: ServiceCommandDescriptorAminoMsg,
  ): ServiceCommandDescriptor {
    return ServiceCommandDescriptor.fromAmino(object.value);
  },
  toAminoMsg(
    message: ServiceCommandDescriptor,
  ): ServiceCommandDescriptorAminoMsg {
    return {
      type: "cosmos-sdk/ServiceCommandDescriptor",
  ...
  fromProtoMsg(
    message: ServiceCommandDescriptorProtoMsg,
  ): ServiceCommandDescriptor {
  ...
  toProtoMsg(
    message: ServiceCommandDescriptor,
  ): ServiceCommandDescriptorProtoMsg {
    return {
      typeUrl: "/cosmos.autocli.v1.ServiceCommandDescriptor",
...
export const RpcCommandOptions_FlagOptionsEntry = {
  ...
  fromPartial(
    object: Partial<RpcCommandOptions_FlagOptionsEntry>,
  ): RpcCommandOptions_FlagOptionsEntry {
    const message = createBaseRpcCommandOptions_FlagOptionsEntry();
    message.key = object.key ?? "";
    message.value =
  ...
  fromAmino(
    object: RpcCommandOptions_FlagOptionsEntryAmino,
  ): RpcCommandOptions_FlagOptionsEntry {
    const message = createBaseRpcCommandOptions_FlagOptionsEntry();
    if (object.key !== undefined && object.key !== null) {
      message.key = object.key;
  ...
  toAmino(
    message: RpcCommandOptions_FlagOptionsEntry,
  ): RpcCommandOptions_FlagOptionsEntryAmino {
    const obj: any = {};
    obj.key = message.key === "" ? undefined : message.key;
  ...
  fromAminoMsg(
    object: RpcCommandOptions_FlagOptionsEntryAminoMsg,
  ): RpcCommandOptions_FlagOptionsEntry {
    return RpcCommandOptions_FlagOptionsEntry.fromAmino(object.value);
  },
  fromProtoMsg(
    message: RpcCommandOptions_FlagOptionsEntryProtoMsg,
  ): RpcCommandOptions_FlagOptionsEntry {
  ...
  fromAmino(object: RpcCommandOptionsAmino): RpcCommandOptions {
    ...
    message.positionalArgs =
      object.positional_args?.map((e) =>
        PositionalArgDescriptor.fromAmino(e),
      ) || [];
...
export const FlagOptions = {
  ...
  fromAmino(object: FlagOptionsAmino): FlagOptions {
    ...
    if (
      object.shorthand_deprecated !== undefined &&
      object.shorthand_deprecated !== null
    ) {
...
export const PositionalArgDescriptor = {
  ...
  fromPartial(
    object: Partial<PositionalArgDescriptor>,
  ): PositionalArgDescriptor {
    const message = createBasePositionalArgDescriptor();
  ...
  toAmino(message: PositionalArgDescriptor): PositionalArgDescriptorAmino {
    const obj: any = {};
    obj.proto_field =
      message.protoField === "" ? undefined : message.protoField;
  ...
  fromAminoMsg(
    object: PositionalArgDescriptorAminoMsg,
  ): PositionalArgDescriptor {
    return PositionalArgDescriptor.fromAmino(object.value);
  },
  toAminoMsg(
    message: PositionalArgDescriptor,
  ): PositionalArgDescriptorAminoMsg {
    return {
      type: "cosmos-sdk/PositionalArgDescriptor",
  ...
  fromProtoMsg(
    message: PositionalArgDescriptorProtoMsg,
  ): PositionalArgDescriptor {
  ...
  toProtoMsg(
    message: PositionalArgDescriptor,
  ): PositionalArgDescriptorProtoMsg {
    return {
      typeUrl: "/cosmos.autocli.v1.PositionalArgDescriptor",
