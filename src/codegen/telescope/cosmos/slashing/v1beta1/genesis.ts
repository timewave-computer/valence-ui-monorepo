...
export const GenesisState = {
  ...
  fromAmino(object: GenesisStateAmino): GenesisState {
    ...
    message.signingInfos =
      object.signing_infos?.map((e) => SigningInfo.fromAmino(e)) || [];
    message.missedBlocks =
      object.missed_blocks?.map((e) => ValidatorMissedBlocks.fromAmino(e)) ||
      [];
    return message;
  },
  toAmino(message: GenesisState): GenesisStateAmino {
    ...
    if (message.signingInfos) {
      obj.signing_infos = message.signingInfos.map((e) =>
        e ? SigningInfo.toAmino(e) : undefined,
      );
    } else {
      obj.signing_infos = message.signingInfos;
    }
    if (message.missedBlocks) {
      obj.missed_blocks = message.missedBlocks.map((e) =>
        e ? ValidatorMissedBlocks.toAmino(e) : undefined,
      );
    } else {
...
export const SigningInfo = {
  ...
  fromAmino(object: SigningInfoAmino): SigningInfo {
    ...
    if (
      ...
      message.validatorSigningInfo = ValidatorSigningInfo.fromAmino(
...
export const ValidatorMissedBlocks = {
  ...
  fromAmino(object: ValidatorMissedBlocksAmino): ValidatorMissedBlocks {
    ...
    message.missedBlocks =
      object.missed_blocks?.map((e) => MissedBlock.fromAmino(e)) || [];
    return message;
  },
  toAmino(message: ValidatorMissedBlocks): ValidatorMissedBlocksAmino {
    ...
    if (message.missedBlocks) {
      obj.missed_blocks = message.missedBlocks.map((e) =>
        e ? MissedBlock.toAmino(e) : undefined,
      );
    } else {
      obj.missed_blocks = message.missedBlocks;
    }
