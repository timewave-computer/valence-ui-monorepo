...
export const ListAllInterfacesRequest = {
  ...
  fromProtoMsg(
    message: ListAllInterfacesRequestProtoMsg,
  ): ListAllInterfacesRequest {
  ...
  toProtoMsg(
    message: ListAllInterfacesRequest,
  ): ListAllInterfacesRequestProtoMsg {
    return {
      typeUrl: "/cosmos.base.reflection.v1beta1.ListAllInterfacesRequest",
...
export const ListAllInterfacesResponse = {
  ...
  fromAminoMsg(
    object: ListAllInterfacesResponseAminoMsg,
  ): ListAllInterfacesResponse {
    return ListAllInterfacesResponse.fromAmino(object.value);
  },
  toAminoMsg(
    message: ListAllInterfacesResponse,
  ): ListAllInterfacesResponseAminoMsg {
    return {
      type: "cosmos-sdk/ListAllInterfacesResponse",
  ...
  fromProtoMsg(
    message: ListAllInterfacesResponseProtoMsg,
  ): ListAllInterfacesResponse {
  ...
  toProtoMsg(
    message: ListAllInterfacesResponse,
  ): ListAllInterfacesResponseProtoMsg {
    return {
      typeUrl: "/cosmos.base.reflection.v1beta1.ListAllInterfacesResponse",
...
export const ListImplementationsRequest = {
  ...
  fromAmino(
    object: ListImplementationsRequestAmino,
  ): ListImplementationsRequest {
    const message = createBaseListImplementationsRequest();
  ...
  toAmino(
    message: ListImplementationsRequest,
  ): ListImplementationsRequestAmino {
    const obj: any = {};
    obj.interface_name =
      message.interfaceName === "" ? undefined : message.interfaceName;
    return obj;
  },
  fromAminoMsg(
    object: ListImplementationsRequestAminoMsg,
  ): ListImplementationsRequest {
    return ListImplementationsRequest.fromAmino(object.value);
  },
  toAminoMsg(
    message: ListImplementationsRequest,
  ): ListImplementationsRequestAminoMsg {
    return {
      type: "cosmos-sdk/ListImplementationsRequest",
  ...
  fromProtoMsg(
    message: ListImplementationsRequestProtoMsg,
  ): ListImplementationsRequest {
  ...
  toProtoMsg(
    message: ListImplementationsRequest,
  ): ListImplementationsRequestProtoMsg {
    return {
      typeUrl: "/cosmos.base.reflection.v1beta1.ListImplementationsRequest",
...
export const ListImplementationsResponse = {
  ...
  fromAmino(
    object: ListImplementationsResponseAmino,
  ): ListImplementationsResponse {
    const message = createBaseListImplementationsResponse();
    message.implementationMessageNames =
  ...
  toAmino(
    message: ListImplementationsResponse,
  ): ListImplementationsResponseAmino {
    const obj: any = {};
    if (message.implementationMessageNames) {
      obj.implementation_message_names = message.implementationMessageNames.map(
        (e) => e,
      );
    } else {
  ...
  fromAminoMsg(
    object: ListImplementationsResponseAminoMsg,
  ): ListImplementationsResponse {
    return ListImplementationsResponse.fromAmino(object.value);
  },
  toAminoMsg(
    message: ListImplementationsResponse,
  ): ListImplementationsResponseAminoMsg {
    return {
      type: "cosmos-sdk/ListImplementationsResponse",
  ...
  fromProtoMsg(
    message: ListImplementationsResponseProtoMsg,
  ): ListImplementationsResponse {
  ...
  toProtoMsg(
    message: ListImplementationsResponse,
  ): ListImplementationsResponseProtoMsg {
    return {
      typeUrl: "/cosmos.base.reflection.v1beta1.ListImplementationsResponse",
