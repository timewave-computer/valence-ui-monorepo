...
import {
  ...
  EvidenceListAmino,
  EvidenceListSDKType,
} from "../../../../tendermint/types/evidence";
import {
  Consensus,
  ConsensusAmino,
  ConsensusSDKType,
...
export const Block = {
  ...
  toAmino(message: Block): BlockAmino {
    ...
    obj.data = message.data
      ? Data.toAmino(message.data)
      : Data.toAmino(Data.fromPartial({}));
...
export const Header = {
  ...
  toAmino(message: Header): HeaderAmino {
    ...
    obj.evidence_hash = message.evidenceHash
      ...
      : undefined;
    obj.proposer_address =
      message.proposerAddress === "" ? undefined : message.proposerAddress;
    return obj;
  },
