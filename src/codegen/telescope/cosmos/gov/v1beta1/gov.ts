...
export const TallyParams = {
  ...
  encode(
    ...
    if (message.quorum !== "") {
      writer
        .uint32(10)
        .string(Decimal.fromUserInput(message.quorum, 18).atomics);
    }
    if (message.threshold !== "") {
      writer
        .uint32(18)
        .string(Decimal.fromUserInput(message.threshold, 18).atomics);
    }
    if (message.vetoThreshold !== "") {
      writer
        .uint32(26)
        .string(Decimal.fromUserInput(message.vetoThreshold, 18).atomics);
    }
    return writer;
  },
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        case 1:
          ...
          break;
        case 2:
          message.threshold = Decimal.fromAtomics(
            reader.string(),
            18,
          ).toString();
          break;
        case 3:
          message.vetoThreshold = Decimal.fromAtomics(
            reader.string(),
            18,
          ).toString();
          break;
