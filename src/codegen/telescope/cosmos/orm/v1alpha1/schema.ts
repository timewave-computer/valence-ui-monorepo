...
export const ModuleSchemaDescriptor = {
  ...
  fromAmino(object: ModuleSchemaDescriptorAmino): ModuleSchemaDescriptor {
    ...
    message.schemaFile =
      object.schema_file?.map((e) =>
        ModuleSchemaDescriptor_FileEntry.fromAmino(e),
      ) || [];
  ...
  fromProtoMsg(
    message: ModuleSchemaDescriptorProtoMsg,
  ): ModuleSchemaDescriptor {
...
export const ModuleSchemaDescriptor_FileEntry = {
  ...
  fromAmino(
    object: ModuleSchemaDescriptor_FileEntryAmino,
  ): ModuleSchemaDescriptor_FileEntry {
    const message = createBaseModuleSchemaDescriptor_FileEntry();
    ...
    if (
      object.proto_file_name !== undefined &&
      object.proto_file_name !== null
    ) {
  ...
  toAmino(
    message: ModuleSchemaDescriptor_FileEntry,
  ): ModuleSchemaDescriptor_FileEntryAmino {
    const obj: any = {};
    obj.id = message.id === 0 ? undefined : message.id;
    obj.proto_file_name =
      message.protoFileName === "" ? undefined : message.protoFileName;
    obj.storage_type =
      message.storageType === 0 ? undefined : message.storageType;
    return obj;
  },
  fromAminoMsg(
    object: ModuleSchemaDescriptor_FileEntryAminoMsg,
  ): ModuleSchemaDescriptor_FileEntry {
    return ModuleSchemaDescriptor_FileEntry.fromAmino(object.value);
  },
  toAminoMsg(
    message: ModuleSchemaDescriptor_FileEntry,
  ): ModuleSchemaDescriptor_FileEntryAminoMsg {
    return {
      type: "cosmos-sdk/FileEntry",
  ...
  toProtoMsg(
    message: ModuleSchemaDescriptor_FileEntry,
  ): ModuleSchemaDescriptor_FileEntryProtoMsg {
    return {
      typeUrl: "/cosmos.orm.v1alpha1.FileEntry",
