...
export const registry: ReadonlyArray<[string, GeneratedType]> = [
  ["/cosmwasm.tokenfactory.v1beta1.MsgCreateDenom", MsgCreateDenom],
  ["/cosmwasm.tokenfactory.v1beta1.MsgMint", MsgMint],
  ["/cosmwasm.tokenfactory.v1beta1.MsgBurn", MsgBurn],
  ["/cosmwasm.tokenfactory.v1beta1.MsgChangeAdmin", MsgChangeAdmin],
