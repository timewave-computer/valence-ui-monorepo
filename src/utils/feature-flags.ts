...
export enum FeatureFlags {
  ...
  REBALANCER_DEPOSIT = "NEXT_PUBLIC_FF_REBALANCER_DEPOSIT",
  REBALANCER_MULTIPLE_ACCOUNTS = "NEXT_PUBLIC_FF_ENABLE_MULTIPLE_ACCTS",
  REBALANCE_PRICE_SOURCE_TOGGLE = "NEXT_PUBLIC_FF_REBALANCE_PRICE_SOURCE_TOGGLE",
