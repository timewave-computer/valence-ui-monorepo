...
async function main() {
  ...
  try {
    ...
    const validatedConfig = programsConfigSchema.parse(programsChainConfig);

    console.log("Config generated:", validatedConfig);
    const exportableConfig = `/*
    * DO NOT MODIFY THIS FILE. THIS IS AUTOGENERATED.
    **/
    export const programsChainConfig = ${JSON.stringify(
      validatedConfig,
      null,
      2
    )};`;
