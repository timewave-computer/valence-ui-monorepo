import { LibraryJsonSchema } from "@/app/programs/server";
import { mockSplitterSchema } from "./mock-splitter-schema";
import { mockAstroportLperSchema } from "./mock-astroport-lper-schema";
...
export const mockLibrarySchemaRegistry = {
  neutron15rldvafc5ufsf34fmjegyul32dm8uvjhg3xgk48j0qrrxqd8e0ssagamfj:
    mockSplitterSchema as LibraryJsonSchema,
  neutron12e9sfu7jg28z4dg5qhzjkf50tj05d5la5uwj2auqpedx5ph2757qhe336u:
    mockAstroportLperSchema as LibraryJsonSchema,
};
