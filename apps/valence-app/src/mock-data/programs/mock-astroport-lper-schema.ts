export const mockAstroportLperSchema = {
  ...
  instantiate: {
    ...
    type: "object",
    required: ["config", "owner", "processor"],
    properties: {
      config: {
    ...
    definitions: {
      ...
      LibraryConfig: {
        type: "object",
        required: ["input_addr", "lp_config", "output_addr", "pool_addr"],
        properties: {
          input_addr: {
    ...
    definitions: {
      ...
      FunctionMsgs: {
        oneOf: [
          {
            type: "object",
            required: ["provide_double_sided_liquidity"],
            properties: {
          ...
          {
            type: "object",
            required: ["provide_single_sided_liquidity"],
            properties: {
  ...
  query: {
    ...
    oneOf: [
      ...
      {
        type: "object",
        required: ["get_raw_library_config"],
        properties: {
